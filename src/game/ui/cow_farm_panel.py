...
class CowFarmPanel:
    ...
    def storage_line_texts(farm: CowFarm) -> tuple[str, str, str, str]:
        return (
            flow_line(
                ...
                resource_key="wheat",
                amount=farm.wheat_amount(),
                capacity=farm.wheat_capacity(),
            ),
            flow_line(
                role_key="ui.panel.input",
                resource_key="water",
            ...
            flow_line(
                ...
                resource_key="beef",
                amount=farm.beef_amount(),
                capacity=farm.beef_capacity(),
            ),
            flow_line(
                role_key="ui.panel.output",
                resource_key="hide",
                amount=farm.hide_amount(),
                capacity=farm.hide_capacity(),
            ),
        )
    ...
    def draw(
        ...
        *,
        ...
        reason_surf = body.render(blocked_line(reason), True, (200, 204, 214))
