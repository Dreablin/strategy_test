...
def test_building_panel_storage_line_for_stone_mine() -> None:
    ...
    b.add_to_storage(1)
    assert BuildingPanel.storage_line(b) == i18n.t("ui.common.storage_line", stored=1, capacity=3)


def test_building_panel_storage_line_for_iron_mine() -> None:
    b = IronMine(level=2, grid_pos=(10, 10))
    assert BuildingPanel.storage_line(b) == i18n.t("ui.common.storage_line", stored=0, capacity=5)
...
def test_building_panel_storage_line_for_farm_updates_after_level_up() -> None:
    ...
    assert BuildingPanel.storage_line(b) == i18n.t("ui.common.storage_line", stored=1, capacity=3)
    b.level = 4
    assert BuildingPanel.storage_line(b) == i18n.t("ui.common.storage_line", stored=1, capacity=4)
