...
def test_town_hall_panel_layout_has_no_hire_buttons() -> None:
    ...
    layout = TownHallPanel.layout(surface, town_hall, None, worker_assigned=False)
...
def test_town_hall_panel_click_inside_without_buttons_returns_none() -> None:
    ...
    assert TownHallPanel.click_action(surface, pos, town_hall, None, worker_assigned=False) is None
...
def test_town_hall_panel_close_button_action() -> None:
    ...
    layout = TownHallPanel.layout(surface, town_hall, None, worker_assigned=False)
    assert (
        TownHallPanel.click_action(surface, layout.close.center, town_hall, None, worker_assigned=False)
        == "close"
    )
...
def test_town_hall_panel_draw_smoke() -> None:
    surface = pygame.Surface((800, 600))
    town_hall = TownHall(level=1, grid_pos=(10, 10))
    TownHallPanel.draw(surface, town_hall, None, worker_assigned=False)
